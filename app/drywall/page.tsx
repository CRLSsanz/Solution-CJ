          ...
          <div className="w-3/4">
            <section className="w-full pr-10 flex flex-col">
              <div className="relative w-full h-[600] mb-8">
                <Image
                  src={`/images/drywall1.jpg`} //"/images/electricidad.jpg"
                  alt="Amigurumi"
                  fill
                  sizes=""
                  //width={250}
              ...
              <div className="flex flex-row gap-8">
                <div className="relative w-full h-80">
                  <Image
                    src={`/images/drywall2.jpg`} //"/images/electricidad.jpg"
                    alt="Amigurumi"
                    fill
                    sizes=""
                    //width={250}
                ...
                <div className="relative w-full h-80">
                  <Image
                    src={`/images/drywall3.jpg`} //"/images/electricidad.jpg"
                    alt="Amigurumi"
                    fill
                    sizes=""
                    //width={250}
                ...
                <div className="relative w-full h-80">
                  <Image
                    src={`/images/drywall4.jpg`} //"/images/electricidad.jpg"
                    alt="Amigurumi"
                    fill
                    sizes=""
                    //width={250}
